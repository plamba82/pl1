  ...
  _createClass(UnconnectedReactImportedComponent, [{
    ...
    value: function render() {
      ...
      switch (state) {
        ...
        case STATE_ERROR:
          return ErrorComponent ? _react2.default.Children.only(_react2.default.createElement(ErrorComponent, _extends({ retryImport: this.reload, error: this.state.error }, this.props.forwardProps))) : null;
        default:
          return null;
      }
    }
